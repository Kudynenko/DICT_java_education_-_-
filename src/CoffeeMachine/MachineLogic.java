...
public class MachineLogic {
    ...
    private void buyMenu(){
        System.out.println("What do you wont to buy? 1 - espresso, 2 - latte, 3 - cappuccino, back - to main menu:");
    ...
    private void machineMenu(String uChoise){
        switch (uChoise){
            case "buy" -> buyMenu();
            ...
            default -> System.out.println(String.format("Unknow command: %s", uChoise));
        }
    }
