...
public class MachineLogic {
    ...
    private void buyMenu(String outsideInput){
        ...
        switch (uCoffeeType) {
            ...
            default -> System.out.println(String.format("Unknow coffee type: %d", uCoffeeType));
        }
    }
    private void fillAction(String outsideInput){
        switch (fillStage) {
            case 1 -> {System.out.println("Write how many ml milk you wont to add");
                water += Integer.parseInt(outsideInput); fillStage = 2;}
            case 2 -> {System.out.println("Write how many grams of coffee beans you wont to add");
                milk += Integer.parseInt(outsideInput); fillStage = 3;}
            case 3 -> {System.out.println("Write how many cups you wont to add");
    ...
    private void fillInvMenu(){
        currentStatus = "fill";
        fillStage = 1;
        System.out.println("Write how many ml of water you wont to add");
    }
